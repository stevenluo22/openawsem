...
def analyze(args):
    ...
    forces = forces.set_up_forces(oa, computeQ=True, submode=args.subMode, contactParameterLocation=parametersLocation, memory=args.memory, memory_strength = args.memoryStrength, memory_only=args.memoryOnly)
